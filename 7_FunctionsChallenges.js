...
function removeFromString(a_str, startIdx, num){
    return a_str.slice(0, startIdx) + a_str.slice(startIdx + num);
...
// The collection can be a string, an array, or an object. If the collection is a string or array, the third parameter is a starting index 
// for where to search from. If the collection is an object, the function searches for the value among values in the object; 
...
function includes(collect, value, startIdx) {
    let i;
    if (startIdx) {
        i = startIdx;
    } else {
